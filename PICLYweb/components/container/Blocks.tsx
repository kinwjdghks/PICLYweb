...
export const ImageBlock = ({file,ondelete}:{file:File,ondelete:(img:string)=>void}) =>{
    ...
    return <div className="h-full aspect-square relative border-solid border-2 border-picly-default rounded-lg overflow-hidden flex justify-center items-center">
...
export const EmptyBlock = ({updateImage}:{updateImage:(fileList:FileList|null)=>void}) =>{
    ...
    return <div className="h-full aspect-square relative border-solid border-2 border-picly-default rounded-lg flex justify-center items-center">
...
export const TagBlock = ({tag,deleteTag}:{tag:string,deleteTag:(tag:string)=>void}) =>{
    return <div className="w-max h-11 p-2 mr-2 text-xl flex rounded-md text-white bg-picly_darker">
