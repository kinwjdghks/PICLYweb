...
export default function Home() {
  ...
  const ActionBar = () => {
    ...
    return (
      <div className="(action) w-full h-max flex flex-col mb-12 lg:p-0 pt-12 gap-2 mt-auto lg:items-start">
  ...
  return (
    <div className="(mainpage) w-screen h-max relative bg-black flex flex-col align-middle overflow-hidden">
      ...
      <div className="(content) w-full h-[100svh] flex-grow flex flex-col align-middle items-center
        ...
        <div className={`(container) lg:w-1/2 w-full h-full p-12 flex flex-col text-left ${nanumgothic.className}`}>
